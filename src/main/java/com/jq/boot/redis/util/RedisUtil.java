package com.jq.boot.redis.util;


import com.jq.boot.redis.RedisProperties;
...
public class RedisUtil {
    ...
    public void set(String key,String value){
        set(key, value, properties.getExpire());
    }
     ...
     * @return
     */
    public boolean setIfAbsent(String key, Serializable value, long expire) {
     ...
     * @param keyAndValue
     */
    public void multiSet(Map<String,String> keyAndValue){
     ...
     * @param keyAndValue
     */
    public void multiSetIfAbsent(Map<String,String> keyAndValue){
     ...
     * @return
     */
    public Long multiDeleteAndRpush(String key, int expireSeconds, String... values){
        redisTemplate.delete(key);
        BoundListOperations<Object, Object> ops = redisTemplate.boundListOps(key);
        Long result = ops.rightPushAll(values);
        ops.expire(expireSeconds, TimeUnit.SECONDS);
        return result;
    }
     ...
     * @return
     */
    public Set<Object> difference(String key ,Collection<Object> collections){
     ...
     * @return 返回差集的数量
     */
    public Long differenceAndStore(String key,Collection<Object> collections,String newKey){
        return redisTemplate.opsForSet().differenceAndStore(newKey, collections, newKey);
    }
     ...
     * @return
     */
    public List<Object> randomGet(String key,long count){
     ...
     * @return
     */
    public Set<Object> randomGetDistinct(String key,long count){
     ...
     * @param key
     * @param collections key 的集合
     * @return
     */
    public Set<Object> unionSet(String key,Collection<Object> collections){
        return redisTemplate.opsForSet().union(key, collections);
    }
     ...
     * @return destKey 数量
     */
    public Long unionAndStoreSet(String key, Collection<Object> collections,String destKey){
        return redisTemplate.opsForSet().unionAndStore(key, collections, destKey);
    }
     ...
     * @return
     */
    public Long unionAndStoreZset(String key,Collection<String> collections,String destKey){
        return redisTemplate.opsForZSet().unionAndStore(key, collections, destKey);
    }
     ...
     * @return
     */
    public Long intersectAndStore(String key,Collection<String> collections,String destKey){
        return redisTemplate.opsForZSet().intersectAndStore(key, collections, destKey);
    }
